<div class="right_col" role="main">
    ...
    <section>
        <div class="page-title">
            <div class="title_left">
                <h3>Data Train Balita Normalized</h3>
            </div>
        </div>
        <div class="flash-dataw" data-flashdata="<?php echo $this->session->flashdata('msg'); ?>"></div>
        <?php if ($this->session->flashdata('msg')) : ?>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <a href="<?= site_url('knn/normalize'); ?>" class="btn btn-primary">Normalize Data</a>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <table id="datatable-0" class="table table-striped table-bordered" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Nama</th>
                                        ...
                                        <tbody>
                                            <?php $i = 1; ?>
                                            <?php foreach ($balitaDataNormalized as $b) : ?>
                                                <tr <?php if ($b->bbtb_label === "INVALID") echo "class='table-danger'" ?>>
                                                    <th scope="row">
                                                        <center><?= $i; ?></center>
                                                    </th>
