    ...
    <section class="content-header">
      <h1>
       Detail Data Kelurahan
        <small>Form Detail Kelurahan</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url();?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?php echo site_url('kelurahan');?>">Data Kelurahan</a></li>
        <li><a href="#">Detail Data Kelurahan</a></li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">
          <?php echo anchor('kelurahan','Kembali',array('class'=>'btn btn-sm btn-danger'));?></h3>
