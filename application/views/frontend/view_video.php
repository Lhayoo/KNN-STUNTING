      ...
      <div class="col-md-7 col-lg-8 p-b-30">
        <div class="p-r-10 p-r-0-sr991">
          <div class="row text-center text-lg-left">
            <?php foreach ($video->result_array() as $row): ?>
              <div class="col-md-6">
                <iframe width="300" height="225" src="<?php echo $row['post_content']; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            <?php endforeach; ?>
          </div>
        </div>
          ...
          <div>
            ...
            <ul class="p-t-35">
              ...
              <li class="flex-wr-sb-s p-b-30">
                <a href="<?= base_url() ?>berita/<?php echo $row['post_slug']; ?>" class="size-w-10 wrap-pic-w hov1 trans-05">
                  <img src="<?= base_url() ?>uploads/blog/<?php echo $row['post_image']; ?>" alt="IMG">
                </a>

                <div class="size-w-11">
                  <h6 class="p-b-4">
                    <a href="<?= base_url() ?>berita/<?php echo $row['post_slug']; ?>" class="f1-s-5 cl3 hov-cl10 trans-05">
