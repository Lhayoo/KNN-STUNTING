                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item <?= $no == 1 ? 'active' : '' ?>">
                            <img height="200" width="960px" class="d-block w-100"
                                src="<?php echo base_url().'uploads/slider/'. $row->slide_image?>" alt="First slide">
                ...
                <div class="p-b-20">
                    ...
                    <div class="tab01 p-b-20">
                        <div class="tab01-head how2 how2-cl1 bocl12 flex-s-c m-r-10 m-r-0-sr991">
                            ...
                            <!--  -->
                            <a href="<?= base_url() ?>berita/kategori/kota"
                            ...
                            <div class="tab-pane fade show active" id="tab1-1" role="tabpanel">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 p-r-25 p-r-15-sr991">
                                        <!-- Item post -->
                                        <div class="m-b-30">
                                            <a href="<?= base_url() ?>berita/<?php echo $row['post_slug']; ?>"
                                                class="wrap-pic-w hov1 trans-03">
                                                <img src="<?= base_url() ?>uploads/blog/<?php echo $row['post_image']; ?>"
                                                    alt="IMG">
                                            </a>
                    ...
                    <div class="tab01 p-b-20">
                        <div class="tab01-head how2 how2-cl2 bocl12 flex-s-c m-r-10 m-r-0-sr991">
                            ...
                            <!--  -->
                            <a href="<?= base_url() ?>berita/kategori/lainnya"
                                class="tab01-link f1-s-1 cl9 hov-cl10 trans-03">
                                Lihat Semua
                                <i class="fs-12 m-l-5 fa fa-caret-right"></i>
                            </a>
