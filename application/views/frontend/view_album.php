            ...
            <?php foreach ($query->result() as $row): ?>
              <div class="col-md-6">
                <div class="card mb-4 box-shadow">
                  <a href="<?php echo site_url("album/view_photo/". $row->album_id)?>"><img class="card-img-top" src="<?php echo base_url().'uploads/album/'. $row->album_thumbnail?>" alt="Card image cap"></a>
                  <div class="card-body">
                    <p class="card-text"><a href="<?php echo site_url("album/view_photo/". $row->album_id)?>"><?php echo $row->album_name; ?></a></p>
                  </div>
                </div>
              </div>
            <?php endforeach; ?>
